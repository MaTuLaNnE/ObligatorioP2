...
namespace ObligatorioP2.Models
{
    public abstract class BaseDeDatos
    {
        ...
        public static void PrecargarBD()
        {
            ...
            Orden Orden1 = new Orden(1, Cli1, Tec2, DateTime.Now, "Este es el problema", DateTime.Now, Estado.ENPROGRESO, list1);
            Orden Orden2 = new Orden(2, Cli1, Tec1, DateTime.Now, "Este es el problema nuevo", DateTime.Now, Estado.COMPLETADO, list2);
